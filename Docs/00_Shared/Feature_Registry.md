...
| EPIC-POLICY-SYNC-RUNTIME | Kid Agent | Versioned sync + watchdog + rollback/integrity | 🟢 | Kid agent | Versioned sync + replay protection + offline cache + integrity check; best-effort rollback to last-known-good cache on apply failures; server surfaces apply failures + rollback recommendation | KFT-006+ (26W09L) |
