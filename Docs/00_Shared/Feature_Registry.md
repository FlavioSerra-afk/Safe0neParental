...
| EPIC-ENFORCE-SCREENTIME | Kid Agent | Enforcement: budgets/schedules/modes | 🟢 | Kid agent + block screens + request loop | SSOT: policy enforcement state | Warnings + lock + blocked UX + deterministic MoreTime request on depletion (idempotent) |
