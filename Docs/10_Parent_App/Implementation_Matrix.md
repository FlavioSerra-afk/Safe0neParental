...
| P-AUDIT-001 | Compliance | Append-only audit log for policy changes | Win✅ | ✅ | 26W08: SSOT-backed append-only audit stream + endpoint + basic viewer; policy PUT/PATCH and device revoke append entries; export/polish is follow-up. |
